    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Add Maillist</li>
            </ol>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="frmInfor" action="{{ route('mailliststore') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" name="email" id="inputEmail" type="text" value="{{ old('email') }}" />
